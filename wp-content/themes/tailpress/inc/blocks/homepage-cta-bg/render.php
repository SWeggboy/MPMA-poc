    ...
    <div class="<?php echo $backgroundImage || $gradient ? 'relative' : ''; ?> <?php echo esc_attr($containerClass); ?>">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white p-[15px] rounded-[10px]" style="box-shadow: 0px 12px 10px -10px rgba(0, 0, 0, 0.15);">
                ...
                <h4 class="text-xl font-bold mb-3 text-center uppercase font-roboto-slab text-cta-gray"><?php echo esc_html($iconBox1Title); ?></h4>
            ...
            <div class="bg-white p-[15px] rounded-[10px]" style="box-shadow: 0px 12px 10px -10px rgba(0, 0, 0, 0.15);">
                ...
                <h4 class="text-xl font-bold mb-3 text-center uppercase font-roboto-slab text-cta-gray"><?php echo esc_html($iconBox2Title); ?></h4>
            ...
            <div class="bg-white p-[15px] rounded-[10px]" style="box-shadow: 0px 12px 10px -10px rgba(0, 0, 0, 0.15);">
                ...
                <h4 class="text-xl font-bold mb-3 text-center uppercase font-roboto-slab text-cta-gray"><?php echo esc_html($iconBox3Title); ?></h4>
            ...
            <div class="bg-white p-[15px] rounded-[10px]" style="box-shadow: 0px 12px 10px -10px rgba(0, 0, 0, 0.15);">
                ...
                <h4 class="text-xl font-bold mb-3 text-center uppercase font-roboto-slab text-cta-gray"><?php echo esc_html($iconBox4Title); ?></h4>
